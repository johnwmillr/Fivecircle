...
(function() {
  ...
  jQuery(function() {
    var coords, fileUploadAJax, geo_error, geo_options, map, marker, markersArray, testAjax, updateMap, zoom_and_pan_were_set;
    markersArray = [];
    map = null;
    marker = null;
    ...
    testAjax = function(location) {
      var lat, lon;
      lat = coords.latitude;
      lon = coords.longitude;
      return $.ajax(':user_id/checkin', {
        type: "POST",
        dataType: "text",
        data: {
          coordinates: {
        ...
        success: function(results) {
          console.log(results);
          return window.location = results;
        }
      });
    };
