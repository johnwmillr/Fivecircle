...
(function() {
  jQuery(function() {
    var coords, fileUploadAJax, geo_error, geo_options, map, marker, markersArray, updateMap, zoom_and_pan_were_set;
    markersArray = [];
    map = null;
    marker = null;
...
window.onload = function() {
    ...
    for (var i = 0, row; row = table.rows[i]; i++) {
       ...
       alert('add marker at (' + lat + ', ' + lon + ') with icon ' + url + ' to map ' + map);
